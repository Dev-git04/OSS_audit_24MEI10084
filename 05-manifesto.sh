...
echo "My name is $name, and I believe in the power of open-source software. My favorite project is $project, and I think the most important aspect of open-source software is $aspect." > "$(whoami).txt"